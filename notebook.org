...
less technical than the remaining entries). 
...
*** Generative Attempts
    :PROPERTIES:
    :CUSTOM_ID: generative-attempts
    :END:

  This notebook briefly describes a history of attempts at getting a
  generative neural network to learn how to best represent digits for a
  given phosphene map.
