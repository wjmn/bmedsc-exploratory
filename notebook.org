...
accuracies = [sum(d[1]['digit'] == d[1]['keypress'])/len(d) for d in data]
...
6. This isn't a criticism, but I sort of see this as confronting two
   ...
   (at least as it stands) will be resting on 2. I think I would
   prefer to have further discussion on 1 and actually for the
   emphasis to mostly be on 1) since I feel that is the more
   interesting aspect, but I'm not sure whether this would be seen as
   "not research."
