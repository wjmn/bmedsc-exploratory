...
Figure \ref{fig:orge997186} illustrates the mapping of a 64-electrode array to phosphene locations measured by perceptual testing.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./graphics/litreview/map.png}
\caption[Spatial distribution of phosphenes mapped to the visual fields]{\label{fig:orge997186}
...
\begin{figure}[htbp]
\centering
\includegraphics[height=\textheight]{./images/results_over_epochs_576.png}
\caption{\label{fig:org440d270}
...
Figure \ref{fig:orgdf768e3} shows the generated phosphene patterns at the 16th epoch for a regular cartesian grid of 576 phosphenes, the highest resolution and simplest arrangement tested.
