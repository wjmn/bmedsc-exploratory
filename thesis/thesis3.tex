...
Figure \ref{fig:org570b705} illustrates the mapping of a 64-electrode array to phosphene locations measured by perceptual testing.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./graphics/litreview/map.png}
\caption[Spatial distribution of phosphenes mapped to the visual fields]{\label{fig:org570b705}
...
Figure \ref{fig:orgdcf4885} shows the generated phosphene patterns at the 16th epoch for a regular cartesian grid of 576 phosphenes, the highest resolution and simplest arrangement tested.
