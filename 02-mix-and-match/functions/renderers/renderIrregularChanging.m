function rendered = renderIrregularChanging(processed, upscale)
%RENDERIRREGULARCHANGING Renders a processed binary image on an irregular phosphene
%grid with circular phosphenes.
%   rendered = RENDERIRREGULARCHANGING(processed, upscale) takes a (height, width)
